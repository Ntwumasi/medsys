...
const ReceptionistDashboard: React.FC = () => {
  ...
  const handleOpenEditPatient = async (patient: Patient) => {
    // Fetch full patient details including extended fields
    try {
      const response = await apiClient.get(`/patients/${patient.id}`);
      const fullPatient = response.data.patient;
      ...
      setEditingPatient({
        ...
        gps_address: fullPatient.gps_address || '',
        city: fullPatient.city || '',
        region: fullPatient.region || fullPatient.state || '',
        preferred_clinic: fullPatient.preferred_clinic || '',
        vip_status: fullPatient.vip_status || '',
        emergency_contact_name: fullPatient.emergency_contact_name || '',
        emergency_contact_phone: fullPatient.emergency_contact_phone || '',
        emergency_contact_relationship: fullPatient.emergency_contact_relationship || '',
        pcp_name: fullPatient.pcp_name || '',
        pcp_phone: fullPatient.pcp_phone || '',
        allergies: fullPatient.allergies || '',
        nationality: fullPatient.nationality || '',
      });
  ...
  const handleSavePatientEdit = async () => {
    ...
    try {
      await apiClient.put(`/patients/${editingPatient.id}`, {
        ...
        gps_address: editingPatient.gps_address,
        city: editingPatient.city,
        region: editingPatient.region,
        preferred_clinic: editingPatient.preferred_clinic,
        vip_status: editingPatient.vip_status,
        ...
        pcp_name: editingPatient.pcp_name,
        pcp_phone: editingPatient.pcp_phone,
      ...
      // Refresh data and update selected patient
      await loadData();
      ...
      if (selectedPatient && selectedPatient.id === editingPatient.id) {
        ...
        setSearchTerm(`${editingPatient.first_name} ${editingPatient.last_name} (${selectedPatient.patient_number})`);
      }
    } catch (error) {
      console.error('Error updating patient:', error);
      const apiError = error as ApiError;
      const errorMessage = apiError.response?.data?.message || apiError.response?.data?.error || 'Failed to update patient';
      showToast(errorMessage, 'error');
    } finally {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
              <h3 className="text-xl font-bold text-gray-900">Edit Patient Information</h3>
              <button
                onClick={() => {
                  setShowEditPatientModal(false);
                  setEditingPatient(null);
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      value={editingPatient.date_of_birth ? editingPatient.date_of_birth.split('T')[0] : ''}
                  ...
                  <div>
                    ...
                    <select
                      value={editingPatient.preferred_clinic}
                      onChange={(e) => setEditingPatient({ ...editingPatient, preferred_clinic: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    >
                      <option value="">Select Clinic</option>
                      {clinics.map((clinic) => (
                  ...
                  <div>
                    ...
                    <select
                      value={editingPatient.vip_status}
                      onChange={(e) => setEditingPatient({ ...editingPatient, vip_status: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    >
                      <option value="">None</option>
                      <option value="silver">Silver</option>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={editingPatient.gps_address}
                      onChange={(e) => setEditingPatient({ ...editingPatient, gps_address: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                      placeholder="e.g., GA-123-4567"
                    />
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      value={editingPatient.emergency_contact_relationship}
                      onChange={(e) => setEditingPatient({ ...editingPatient, emergency_contact_relationship: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    >
                      <option value="">Select Relationship</option>
                      <option value="Spouse">Spouse</option>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      value={editingPatient.pcp_name}
                      onChange={(e) => setEditingPatient({ ...editingPatient, pcp_name: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      type="tel"
                      value={editingPatient.pcp_phone}
                      onChange={(e) => setEditingPatient({ ...editingPatient, pcp_phone: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    />
                  </div>
                </div>
            ...
            <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
              ...
              <button
                ...
                disabled={savingPatientEdit || !editingPatient.first_name || !editingPatient.last_name}
