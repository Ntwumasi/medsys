    ...
    <div className="relative">
      ...
      <div className="relative">
        <textarea
          ...
          disabled={disabled}
          required={required}
          className={`w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none transition-all shadow-sm hover:border-gray-300 ${
        ...
        {showSuggestions && suggestions.length > 0 && (
          <div
            ref={suggestionsRef}
            className="absolute z-50 w-full mt-1 bg-white border-2 border-primary-200 rounded-xl shadow-lg max-h-64 overflow-y-auto"
          >
            <div className="px-3 py-2 bg-gradient-to-r from-primary-50 to-secondary-50 border-b border-primary-100">
            ...
            {suggestions.map((suggestion, index) => (
              ...
              >
                <svg className={`w-4 h-4 flex-shrink-0 ${index === selectedIndex ? 'text-primary-600' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
