    ...
    <div ref={searchRef} className="relative w-full max-w-md">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pl-10 pr-4 text-gray-900 placeholder-gray-500 border border-white border-opacity-30 bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white shadow-sm"
          style={{ color: '#111827' }}
        />
        <svg
